...
Tools = [
	...
	"newCabinet", "png", "newCabinet, parametric cabinet starter", "Creates a new document with a Params spreadsheet and a 4-panel cabinet carcass (top, bottom, two sides) whose dimensions are driven by spreadsheet aliases. Edit the Params spreadsheet to resize the cabinet; all panels update automatically.",
